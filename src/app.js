var HelloWorldLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        // Adding Title
        var helloLabel = new cc.LabelTTF(" TicTacToe", "Comic Sans", 38);
        ...
        function checkWinningState(){
            ...
            if(target.winningState != "-"){
                if(target.winningState != "tie"){
                    if(target.winningState == "Niña")
                    alert("Ganador: X , Felicidades");
                    else{
                    alert("Ganador: O , Felicidades")    
                    }
                } else{
                    alert("Empatados!");
                }
